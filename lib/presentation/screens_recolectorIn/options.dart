...
import 'package:bioallin/presentation/screens_recolectorIn/perfil_screen.dart';
                ...
                NavBarIcon(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const HistorialReScreen()),
                      );
                    },
                    defaultColor: secondaryColor,
                    selectedColor: primaryColor),
...
class NavBarIcon extends StatelessWidget {
  const NavBarIcon(
      ...
      this.selectedColor = const Color.fromARGB(255, 85, 174, 212),
